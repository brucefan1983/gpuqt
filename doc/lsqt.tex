...
\verb"GPUQT" is an efficient and flexible implementation of the linear scaling quantum transport (LSQT) methods reviewed in \citet{fan2018arxiv}.  The \verb"GPUQT" code is not fully finished yet, and we aim to complete version 1.0 within a few months.
...
\item When you use \verb"GPUQT" to do calculations related to Hall transport (not implemented yet), you can cite \citet{ortmann2015prb} and \citet{garcia2015prl}.
